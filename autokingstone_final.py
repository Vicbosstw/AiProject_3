...
keywords = [
    'ogc','ogb','oge','ogf','ogg','ogh','ogi','ogl','ogk','ogj','ogz','ogm','okd','oka','oke','okg','oki','okh','okb','okf','oda','odi','odb','odc','ode','odf','odd',
...
for keyword in keywords:
    ...
    if soup.select('div[class="txtregion_resultno"]') == []:
        ...
        df.to_csv("./kingstone_datas/books/kingstone_{}.csv".format(keyword),
                  encoding="utf-8-sig", index=False)
        df_intro.to_csv("./kingstone_datas/intros/kingstone_{}_intro.csv".format(
            keyword), encoding="utf-8-sig", index=False)
        print("Completed")
    time.sleep(5)
